...
window.onload=async _=>{
    ...
    h += '<p><span style="color:blue">*</span> right ... not as much as you might have expected. Remember the information here is the one you provide when you click on a link, no information is being pulled from the browser itself - for example, the geolocation information is the one the host url gets from the <a href="https://us-central1-nih-nci-dceg-episphere-dev.cloudfunctions.net/helloMe" target="_blank">call itself</a>, not from the browser location API. Even a completely nacked call in your command line, such as <span style="background-color:black;color:lime"> curl <a style="background-color:black;color:lime" href="https://us-central1-nih-nci-dceg-episphere-dev.cloudfunctions.net/helloMe">&nbsp;https://us-central1-nih-nci-dceg-episphere-dev.cloudfunctions.net/helloMe</a> </span>, has a footprint with plenty of machine and location information.</p>'
